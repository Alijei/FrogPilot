...
class CarController(CarControllerBase):
    def __init__(self, dbc_name, CP, VM):
        ...
        # Désactiver SCC pour le Hyundai Tucson 4th Gen
        if self.CP.carFingerprint == CAR.HYUNDAI_TUCSON_4TH_GEN:
            self.CP.openpilotLongitudinalControl = False  # Ne pas gérer l'ACC
    ...
    def update(self, CC, CS, now_nanos, frogpilot_toggles):
        ...
        # Accélération (pas d'ACC pour le Tucson 4th Gen)
        ...
        if self.CP.carFingerprint in CANFD_CAR:
            ...
            if self.CP.openpilotLongitudinalControl and self.CP.carFingerprint != CAR.HYUNDAI_TUCSON_4TH_GEN:
                if self.frame % 2 == 0:
            ...
            can_sends.append(hyundaican.create_lkas11(
                self.packer, self.frame, self.CP, apply_steer, apply_steer_req,
            ...
            if self.CP.openpilotLongitudinalControl and self.CP.carFingerprint != CAR.HYUNDAI_TUCSON_4TH_GEN:
                if self.frame % 2 == 0:
                    ...
                    can_sends.extend(hyundaican.create_acc_commands(self.packer, CC.enabled, accel, jerk, int(self.frame / 2),
                                                                    ...
                                                                    CC.cruiseControl.override, False, CS.out.cruiseState.available))
